...
export function SnippetList({ dict, lang }: { dict: any; lang: string }) {
  ...
  return (
    <div className="container py-8 mx-auto px-4">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold mb-2">{dict.snippetList.title}</h1>
          <p className="text-muted-foreground">{dict.snippetList.description}</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              placeholder={dict.snippetList.searchPlaceholder}
              value={search}
