...
export default function SnippetPage() {
  ...
  const analysis = snippet ? analyzeComplexity(snippet.code) : null;
    ...
    <div className="container py-8 max-w-5xl mx-auto">
      <div className="space-y-6">
              ...
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button variant="destructive" size="sm">
                    {deleting ? <Spinner /> : <Trash2 className="h-4 w-4 mr-2" />}
                    Delete
                  </Button>
                </AlertDialogTrigger>
                <AlertDialogContent>
        ...
        {analysis && (
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Time Complexity Analysis</CardTitle>
              <CardDescription>Automatic estimation based on code patterns</CardDescription>
            </CardHeader>
            <CardContent>
              <ComplexityBadge analysis={analysis} showDetails />
            </CardContent>
          </Card>
        )}
      </div>
