  ...
  return (
    <div className="container py-8 mx-auto">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold mb-2">Browse by Tags</h1>
          <p className="text-muted-foreground">
            Explore code snippets organized by topics and categories
          </p>
        </div>
          ...
          fetching ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  No tags yet. Create a snippet to get started!
                </p>
              </CardContent>
            </Card>
          )
